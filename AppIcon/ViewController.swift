...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        let nib = NSNib(nibNamed: "CollectionCell", bundle: nil)
        collectionView.register(nib, forItemWithIdentifier: .init("CollectionCell"))
    }
...
extension ViewController: NSCollectionViewDelegate, NSCollectionViewDataSource {
    ...
    func collectionView(_ collectionView: NSCollectionView, itemForRepresentedObjectAt indexPath: IndexPath) -> NSCollectionViewItem {
        let item = collectionView.makeItem(withIdentifier: .init("CollectionCell"), for: indexPath) as! CollectionCell
